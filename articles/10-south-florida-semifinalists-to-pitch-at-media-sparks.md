---
title: "10 South Florida semifinalists to pitch at Media Sparks"
...
* [SociallyBuzz](http://www.sociallybuzz.com/App): a social media management, marketing and advertising company for businesses.
* [Jurnid](https://www.jurnid.com/): a simple way to publish and read news stories of any genre.
* [Everypost](http://everypost.me/): an app that allows an easy and convenient way to post multimedia content across multiple social platforms.
* [Handprint](https://www.handprint.me/en/): a smartphone that international travelers can use in the United States that offers a daily, flat rate for talk, text and data.
* [Partnetting](https://www.facebook.com/partnetting?ref=br_tf): a business-to-business online community that facilitates and recommends connections between enterprises.
* [Yandiki](http://yandiki.com/): a digital services company that helps businesses hire and manage creative talent and services from around the world.
* [Komuns](https://www.facebook.com/komuns): a social network that helps parents meet new families and share events together.
* [Smart Beemo](http://www.smartbeemo.com/): a digital marketing tool that helps boost social media campaigns with real-time intelligence and data.
* [MediaAmplify](http://mediamplify.com/): a one-stop-shop media distribution platform through which multimedia content is delivered from one platform to all devices including traditional cable/satellite.
* [Bederr](http://www.bederr.com/): a smartphone app that allows people to access loyalty programs, credit card services and other benefits in one place, as well as connect with local businesses.

At the event, the semi-finalists will have five minutes to present, followed by five minutes of a judge-led question and answer session. Finalists will move on to present at the Festival of Media LatAm. To register as an attendee, visit [www.mediasparks.eventbrite.com](http://www.mediasparks.eventbrite.com/).
...
For more information visit [www.festivalofmedia.com/latam/media-sparks](http://www.festivalofmedia.com/latam/media-sparks) or contact Danny Lafuente at [danny@thelabmiami.com](https://web.archive.org/web/20140925085925/mailto:danny@thelabmiami.com).
