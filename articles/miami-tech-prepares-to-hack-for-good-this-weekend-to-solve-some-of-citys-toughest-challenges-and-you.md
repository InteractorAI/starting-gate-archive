---
title: "Miami Tech prepares to Hack for Good this weekend to solve some of city’s toughest challenges (and you’re invited!)"
date: "February 29, 2016"
author: "Nancy Dahlberg 02/29/2016"
---
...
![Hackforgood](../images/6a00d83451b26169e201b8d1a5f9f3970c-250wi.jpg "Hackforgood")Three of Miami’s most prominent tech organizations are setting out to make an impact on their community. Tech and entrepreneurship organization [Refresh Miami](https://www.refreshmiami.com/), Florida’s top code school [Wyncode Academy](http://wyncode.co/), and Code for America brigade [Code for Miami](http://codefor.miami/) have joined forces to organize the first annual Hack-For-Good hackathon, taking place March 4th to 6th at The LAB Miami in Wynwood. The purpose of the event is to pair local nonprofits and charities with the city’s top “hackers” (programmers, designers, creators and business leaders) to build solutions to their toughest challenges through the use of technology.
...
* [Make the Homeless Smile Miami](https://www.facebook.com/Make-The-Homeless-Smile-MIAMI-241121882757020/), which aims to heal disenfranchised communities by treating them with dignity, empowering them with knowledge and providing them with access.
* [Apretaste](https://apretaste.com/), whose mission is to connect underdeveloped countries to the web free of charge and open them up to a whole world of opportunities.
* [Miami Dade Animal Services](http://www.miamidade.gov/animals/), which saves the lives of abandoned animals and helps reunite lost pets with their owners.
* [Fairchild Tropical Botanic Garden](http://www.fairchildgarden.org/), a group dedicated to tropical plant diversity and inspiring a greater knowledge and love for plants and gardening.
* [Switchboard](http://switchboardmiami.org/), an organization that counsels, connects and empowers people in need through their more than 15 specialty phone lines, which include free and confidential telephone counseling, crisis intervention, suicide intervention, and more.

The hackathon offers exciting cash and prizes for the top three projects created over the weekend that best solve the issues presented by the charities. The event’s headline sponsor is the [Knight Foundation](http://knightfoundation.org/) with space donated by [The LAB Miami](http://www.thelabmiami.com/). Local companies LiveNinja, OpenEnglish, MadChiller, Lemon City Tea and Concrete Beach will also be onsite providing hackers with some much need fuel and support to keep them going throughout the three-day event.
...
Danielle Ungermann, community and events coordinator for Code for Miami, adds “We’re pleased to see how far South Florida has come in pushing forward and supporting civic initiatives like the [Miami-Dade open data portal](https://opendata.miamidade.gov/), which launched during last year’s CodeAcross event. We only hope that this weekend’s community-wide collaboration will continue to grow and extend outside of this event to show just how much can be achieved through the cross pollination of different communities and industries.”

Participation in the event is free and those interested can register [here](https://www.eventbrite.com/e/2016-hack-for-good-tickets-21462957283).
