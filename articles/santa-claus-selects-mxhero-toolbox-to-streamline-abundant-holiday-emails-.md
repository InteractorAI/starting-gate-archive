---
title: "Santa Claus selects mxHero ToolBox to streamline abundant holiday emails"
...
Email Toolbox can be downloaded for free from [toolbox.mxhero.com](http://toolbox.mxhero.com/). It is currently available in English, Spanish and Portuguese language translations. MxHero's Google Apps products are available at <http://hero.mx/gapps>
...
[mxHero](http://www.mxhero.com/) is an email enhancement platform and app store that gives companies, service providers and end users powerful new ways to control, use and analyze email. Apps developed for mxHero’s platform work with any email management program, including Gmail and Microsoft Exchange. More than 5,500 companies with 350,000 users have added mxHero to their email capabilities.